...
public class TopNFinderBolt extends BaseBasicBolt {
 ...
 /*
    ...
    ------------------------------------------------- */
	  Integer wordCount = currentTopWords.get(tuple.getString(0));
	  if(null == wordCount ||0 == wordCount) {
		  currentTopWords.put(tuple.getString(0), 1);
	  } else {
		  currentTopWords.put(tuple.getString(0), wordCount++);		  
	  }
